...
#
#================================================================
#todo: python convert_tfrecord.py  --dataset_txt  plate_train_data.txt  --tfrecord_path_prefix  ./train_data_tfrecord/
import sys
import argparse
import numpy as np
...
def main(argv):
    ...
    parser.add_argument("--tfrecord_path_prefix", default=None)
